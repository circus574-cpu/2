        ...
        <div className="space-y-5">
          ...
          <div className="rounded-lg p-4" style={{ backgroundColor: CARD_BG, border: `1px solid ${CARD_BORDER}` }}>
            <svg viewBox="0 0 260 70" className="w-full h-16">
              <line x1="15" y1="50" x2="245" y2="50" stroke={TEXT_FAINT} strokeWidth="1.2" />
              <line x1="15" y1="10" x2="15" y2="55" stroke={TEXT_FAINT} strokeWidth="1.2" />
              <line x1="245" y1="10" x2="245" y2="55" stroke={TEXT_FAINT} strokeWidth="1.2" />
              <line x1="10" y1="5" x2="250" y2="5" stroke={EMBER} strokeWidth="1.2" />
              <path d="M10 2 L10 8 M250 2 L250 8" stroke={EMBER} strokeWidth="1.2" />
              <text x="105" y="2" fill={EMBER} fontFamily="JetBrains Mono" fontSize="8">
                {lenDisplay} mb
              </text>
              <line x1="15" y1="10" x2="6" y2="10" stroke={EMBER} strokeWidth="1.2" />
              <line x1="15" y1="55" x2="6" y2="55" stroke={EMBER} strokeWidth="1.2" />
              <text x="-38" y="35" fill={EMBER} fontFamily="JetBrains Mono" fontSize="8" transform="rotate(-90 10,35)">
                {heightDisplay} cm
              </text>
            </svg>
          </div>
